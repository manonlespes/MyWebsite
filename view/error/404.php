<section class="page404">
    ...
    <picture>
        <source media="(min-width:700px)" srcset="public/images/404/Chatshimi_medium.png">
        <source media="(min-width:960px)" srcset="public/images/404/Chatshimi_large.png">
        <img src="public/images/404/Chatshimi_small.png" title="Oops, I did it again!" alt="image_404_Chatshimi"><!-- default -->
    </picture>
